...
public class UpdateSubscription {
	...
	private final Logger LOGGER = LoggerFactory
			.getLogger(UpdateSubscription.class);
	...
	public void updateSubscriptionForUser1() {
		...
		String requestData = requestDataClean(updateAddressBookRequestData,
		...
		Response response = RestAssured
				...
				.ifError()
				.statusCode(200)
				.body("abChangesSubscription.resourceURL",
